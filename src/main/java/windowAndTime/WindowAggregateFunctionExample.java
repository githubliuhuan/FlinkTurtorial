...
public class WindowAggregateFunctionExample {
    public static void main(String[] args) throws Exception {
        ...
        stream.keyBy(data -> true)
                .window(SlidingAlignedProcessingTimeWindows.of(Time.seconds(10),
                        Time.seconds(2)))
                .aggregate(new AvgPv())
                .print();
        env.execute();
    ...
    private static class AvgPv implements AggregateFunction<Event, Tuple2<HashSet<String>,Long>, Double> {
        ...
        @Override
        public Tuple2<HashSet<String>,Long> merge(Tuple2<HashSet<String>,Long> acc, Tuple2<HashSet<String>,Long> acc1) {
            return null;
        }
    }
}
